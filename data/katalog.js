...
const UMKM = [
  ...
  },
  {
    ...
    fotoLokasi: "",
    deskripsi:
      "Jajanan pasar rumahan: molen, pastel, risol sayur, dan onde-onde, " +
      "digoreng dan dijual lepas tanpa kemasan seperti gorengan pada " +
      "umumnya. Adonan " +
...
const PRODUK = [
  ...
  },
  {
    ...
    unggulan: false,
    deskripsi:
      "Risol isi sayuran, dibalut tepung roti dan digoreng garing.",
    rincian: [
      ["Isi", "Sayuran"],
      ["Kemasan", "Tanpa kemasan, dijual lepas"],
      ["Minimal pesan", "GANTI: jumlah minimal"],
  ...
  },
  {
    ...
    unggulan: false,
    deskripsi:
      "Backdrop/bufet TV custom lengkap dengan rak, lampu LED, dan " +
      "aksen panel sesuai desain dan ukuran ruangan pemesan.",
    rincian: [
      ["Jenis pekerjaan", "Pesanan custom, bukan barang jadi"],
      ["Bahan", "GANTI: jenis kayu/material yang dipakai"],
      ["Waktu pengerjaan", "GANTI: perkiraan lama pengerjaan"],
    ],
  },
  {
    ...
    unggulan: false,
    deskripsi:
      "Kitchen set custom sesuai denah dapur pemesan, termasuk kabinet " +
      "atas-bawah dan meja kerja.",
    rincian: [
      ["Jenis pekerjaan", "Pesanan custom, bukan barang jadi"],
      ["Bahan", "GANTI: jenis material yang dipakai"],
      ["Waktu pengerjaan", "GANTI: perkiraan lama pengerjaan"],
    ],
  },
  {
    ...
    unggulan: false,
    deskripsi:
      "Pintu kayu jati solid, dibuat sesuai ukuran dan motif ukiran " +
      "pesanan.",
    rincian: [
      ["Bahan utama", "Kayu jati"],
      ["Ukuran", "GANTI: menyesuaikan pesanan"],
      ["Waktu pengerjaan", "GANTI: perkiraan lama pengerjaan"],
    ],
  },
  {
    ...
    unggulan: false,
    deskripsi:
      "Lemari dan rak penyimpanan custom, disesuaikan dengan kebutuhan " +
      "dan ukuran ruangan.",
    rincian: [
      ["Jenis pekerjaan", "Pesanan custom, bukan barang jadi"],
      ["Bahan", "GANTI: jenis material yang dipakai"],
  ...
  },
  {
    ...
    unggulan: false,
    deskripsi:
      "Meja dan bangku kasir dengan laci penyimpanan, cocok untuk toko " +
      "atau warung.",
    rincian: [
      ["Jenis pekerjaan", "Pesanan custom, bukan barang jadi"],
      ["Bahan", "GANTI: jenis material yang dipakai"],
  ...
  },
  {
    ...
    unggulan: false,
    deskripsi:
      "Meja/rak TV minimalis dengan rak terbuka, finishing putih duco.",
    rincian: [
      ["Jenis pekerjaan", "Bisa custom ukuran"],
      ["Bahan", "GANTI: jenis material yang dipakai"],
      ["Waktu pengerjaan", "GANTI: perkiraan lama pengerjaan"],
    ],
  },
  ...
  },
  {
    ...
    rincian: [["Isi", "Bakso, potongan daging, mi, tahu"]],
  },
  {
    slug: "mie-ayam-andin",
    nama: "Mie Ayam",
    ...
    rincian: [["Isi", "Mi, ayam cincang, sayuran, kuah kaldu"]],
  },
  {
    ...
    unggulan: false,
    deskripsi:
      "Mie yamin bakso porsi biasa, disajikan dengan sayuran dan kerupuk.",
    rincian: [["Isi", "Mi yamin, bakso, sayuran, kerupuk"]],
  },
  {
  ...
  },
  {
    ...
    rincian: [["Varian", "Original, asli Solo"]],
  },
  {
    ...
    rincian: [["Varian", "Rasa jeruk kampul"]],
  },
  {
  ...
  },
  {
    ...
    rincian: [["Varian", "Rasa strawberry"]],
  },
  {
  ...
  },
  {
    ...
    rincian: [["Varian", "Royal chocolate"]],
  },
  {
